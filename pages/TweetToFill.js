  ...
  return (
    <BaseScreen headerShown={false}>
      <View className="flex-1 justify-between mt-28">
        <View>
          <Text className="font-libre-franklin font-bold text-28 mb-5">{content}</Text>
          <TextInput className="font-libre-franklin font-bold text-28 text-white placeholder:text-white/40"
            autoCapitalize="none"
            autoFocus={true}
